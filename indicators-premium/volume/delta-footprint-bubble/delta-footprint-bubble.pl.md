...
- 🧵 **Ślad POC** - linia przez środki bąbelków: _Segmented_ (proste odcinki, rysowane jako plot `POC trail` - grubość i typ linii edytowalne w zakładce **Styl**) albo _Curved_ (wygładzona łamana przez ostatnie ~500 środków). Pokazuje, jak wędruje "uczciwa cena".
